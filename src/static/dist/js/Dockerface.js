...
Elm.Dockerface = Elm.Dockerface || {};
Elm.Dockerface.make = function (_elm) {
   "use strict";
   _elm.Dockerface = _elm.Dockerface || {};
   if (_elm.Dockerface.values) return _elm.Dockerface.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var _op = {};
   var main = $Graphics$Element.show("Docker in your face!");
   return _elm.Dockerface.values = {_op: _op,main: main};
};
